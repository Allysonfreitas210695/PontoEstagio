...
namespace PontoEstagio.Infrastructure.Migrations
{
    ...
    [Migration("20250621165429_AddVerificationCodeUniversityTable")]
    partial class AddVerificationCodeUniversityTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PontoEstagio.Domain.Entities.LegalRepresentative", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PontoEstagio.Domain.Entities.VerificationCodeUniversity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VerificationCodesUniversity", (string)null);
                });
            ...
            modelBuilder.Entity("PontoEstagio.Domain.Entities.LegalRepresentative", b =>
                {
                    ...
                    b.OwnsOne("PontoEstagio.Domain.ValueObjects.Email", "Email", b1 =>
                        {
                            b1.Property<Guid>("LegalRepresentativeId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("LegalRepresentativeId");

                            b1.HasIndex("Endereco")
                                .IsUnique();

                            b1.ToTable("LegalRepresentatives");
            ...
            modelBuilder.Entity("PontoEstagio.Domain.Entities.VerificationCodeUniversity", b =>
                {
                    b.OwnsOne("PontoEstagio.Domain.ValueObjects.Email", "Email", b1 =>
                        {
                            b1.Property<Guid>("VerificationCodeUniversityId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("VerificationCodeUniversityId");

                            b1.ToTable("VerificationCodesUniversity");

                            b1.WithOwner()
                                .HasForeignKey("VerificationCodeUniversityId");
                        });
